...
amended: 2026-07-11（人工批准修正案 A4，版本 v4.3 → v4.3.1；A4 全文见 §14）
supersedes: "Phase 5 Design Draft v4 (lost) + v4.1 patch + v4.2.1 amendment (consolidated)"
related:
  - "[[Phase 5 Design Draft v4.1 — Incremental Schema Patch]]"
  - "[[Phase 5 Design Draft v4.2.1 — Lineage Hardening Amendment]]"
  - "[[S5.1 Closeout Report]]"
...
> **当前版本：v4.3.1**（2026-07-11 人工批准修正案 A4 后 bump；文件名保留 v4.3 以维持既有 [[链接]]，引用本基线时以本行版本为准）。
